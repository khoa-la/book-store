 ...
 * @author lakho
 */
@WebServlet(name = "AdminHideUserController", urlPatterns = {"/AdminHideUserController"})
public class AdminHideUserController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if ("admin".equals(userID)) {
                ...
                DAO dao = new DAO();
                boolean check = dao.hideUser(userID);
                if (check) {
                    url = SUCCESS;
                }
            }
