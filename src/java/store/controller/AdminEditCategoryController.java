...
import store.models.CategoryDTO;
 ...
 * @author lakho
 */
@WebServlet(name = "AdminEditCategoryController", urlPatterns = {"/AdminEditCategoryController"})
public class AdminEditCategoryController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            log("Error at AdminEditCategoryController " + e.toString());
        }finally{
